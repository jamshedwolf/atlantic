...
import img1 from "../assets/k100.svg"
import img2 from "../assets/k100.svg"
  ...
  return (
    ...
    <div className=' py-10 clash bg-[#111219] '>
        <div className="text-center flex flex-col gap-5  items-center justify-center p-5">
            ...
            <div className="text-[#AAAAAA] my-5">Purchase a ticket to win big money</div>
            </div>
    ...
    <div
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center flex-col gap-3">
                            ...
                            <p className="flex justify-between w-[200px] items-center ">
